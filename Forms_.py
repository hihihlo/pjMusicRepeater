# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0 on Sat Nov 30 12:28:05 2024 from "C:\DriveD\MyPro\DataProc\Parser_Script\Python\+media\+voice\pjMusicRepeater\forms_.wxg"
#
...
class FmMain(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu_sub.Append(wx.ID_ANY, _("(No recent file)"), "")
        wxglade_tmp_menu.Append(wx.ID_ANY, _("Recent F&iles"), wxglade_tmp_menu_sub, "")
        wxglade_tmp_menu_sub = wx.Menu()
        wxglade_tmp_menu_sub.Append(wx.ID_ANY, _("(No recent folder)"), "")
        wxglade_tmp_menu.Append(wx.ID_ANY, _("Recent Fol&ders"), wxglade_tmp_menu_sub, "")
