# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.0pre on Tue Nov 19 21:34:00 2024 from "C:\DriveD\MyPro\DataProc\Parser_Script\Python\+media\+voice\pjMusicRepeater\forms_.wxg"
#
...
class FmMain(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        item = wxglade_tmp_menu.Append(wx.ID_ANY, _("&Recent Files"), "")
        self.Bind(wx.EVT_MENU, self.mnRecentFiles, item)
        ...
        bitmap_1 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/count.png", wx.BITMAP_TYPE_ANY))
        bitmap_1.SetMinSize((25, 25))
        sizer_12.Add(bitmap_1, 0, 0, 0)

        self.edDefSn_MainCnt = wx.TextCtrl(self.panel_2, wx.ID_ANY, _("0"))
        ...
        bitmap_2 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/speed.png", wx.BITMAP_TYPE_ANY))
        bitmap_2.SetMinSize((25, 25))
        sizer_12.Add(bitmap_2, 0, 0, 0)

        self.cboDefSn_MainSpeed = wx.ComboBox(self.panel_2, wx.ID_ANY, choices=[_("50%"), _("60%"), _("65%"), _("75%"), _("100%"), _("125%"), _("150%"), _("175%")], style=wx.CB_DROPDOWN | wx.CB_READONLY)
        ...
        bitmap_3 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/count.png", wx.BITMAP_TYPE_ANY))
        bitmap_3.SetMinSize((25, 25))
        sizer_14.Add(bitmap_3, 0, 0, 0)

        self.edDefSn_SubCnt = wx.TextCtrl(self.panel_2, wx.ID_ANY, _("0"))
        ...
        bitmap_4 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/speed.png", wx.BITMAP_TYPE_ANY))
        bitmap_4.SetMinSize((25, 25))
        sizer_14.Add(bitmap_4, 0, 0, 0)

        self.cboDefSn_SubSpeed = wx.ComboBox(self.panel_2, wx.ID_ANY, choices=[_("50%"), _("60%"), _("65%"), _("75%"), _("100%"), _("125%"), _("150%"), _("175%")], style=wx.CB_DROPDOWN | wx.CB_READONLY)
        ...
        bitmap_7 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/count.png", wx.BITMAP_TYPE_ANY))
        bitmap_7.SetMinSize((25, 25))
        sizer_16.Add(bitmap_7, 0, 0, 0)

        self.edDefSn_CopyCnt = wx.TextCtrl(self.panel_2, wx.ID_ANY, _("0"))
        ...
        bitmap_8 = wx.StaticBitmap(self.panel_2, wx.ID_ANY, wx.Bitmap("./icons/speed.png", wx.BITMAP_TYPE_ANY))
        bitmap_8.SetMinSize((25, 25))
        sizer_16.Add(bitmap_8, 0, 0, 0)

        self.cboDefSn_CopySpeed = wx.ComboBox(self.panel_2, wx.ID_ANY, choices=[_("50%"), _("60%"), _("65%"), _("75%"), _("100%"), _("125%"), _("150%"), _("175%")], style=wx.CB_DROPDOWN | wx.CB_READONLY)
        ...
        label_5 = wx.StaticText(self.panel_2, wx.ID_ANY, _("EndMode: "))
        sizer_15.Add(label_5, 0, 0, 0)

        self.cbo_EndMode = wx.ComboBox(self.panel_2, wx.ID_ANY, choices=[_("Stop"), _("Next"), _("RepNum"), _("RepForEver")], style=wx.CB_DROPDOWN | wx.CB_READONLY)
    ...
    def mnRecentFiles(self, event):  # wxGlade: FmMain.<event_handler>
        print("Event handler 'mnRecentFiles' not implemented!")
        event.Skip()
